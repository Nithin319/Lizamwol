...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/+JeWFhkIdXkdiNzc1>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https:t.me/movie_hubby")]])
    )
...
async def pm_next_page(bot, query):
    ...
    if not search: return await query.answer("ᴊᴏɪɴ https://t.me/movie_hubby Rᴇǫᴜᴇsᴛ Aɢᴀɪɴ", show_alert=True)
    ...
    btn.insert(0, [InlineKeyboardButton("⚡ ᴇɴᴊᴏʏ ᴇɴᴊᴀᴍɪɪ 🌾", "howdl")])
...
async def pm_spoll_tester(bot, query):
    ...
    if not movies:
        return await query.answer("ᴊᴏɪɴ https://t.me/movie_hubby Rᴇǫᴜᴇsᴛ Aɢᴀɪɴ", show_alert=True)
